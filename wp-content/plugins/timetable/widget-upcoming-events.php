...
class upcoming_events_widget extends WP_Widget
{
    ...
    function widget($args, $instance)
	{
		...
		$within_next = $instance['within_next'];
		$time_format = $instance['time_format'];
		$time_format_custom = $instance['time_format_custom'];
		$time_mode = $instance['time_mode'];
		$timezone = $instance['timezone'];
		$auto_scroll = $instance['auto_scroll'];
		...
		$hover_text_color = $instance['hover_text_color'];
		$item_border_color = $instance['item_border_color'];
		$hover_item_border_color = $instance['hover_item_border_color'];
		...
		$output .= '</ul><div class="tt_upcoming_event_controls">
			...
			$output .= '<p class="message">' . __('No upcoming events for today', 'timetable') . '</p>';
		endif;
		$output .= '</div>
		</div>';
    ...
    function update($new_instance, $old_instance)
	{
		...
		$instance['display_settings'] = strip_tags($new_instance['display_settings']);
		$instance['within_next'] = strip_tags($new_instance['within_next']);
		$instance['time_format'] = strip_tags($new_instance['time_format']);
		$instance['time_format_custom'] = strip_tags($new_instance['time_format_custom']);
		$instance['time_mode'] = strip_tags($new_instance['time_mode']);
		$instance['timezone'] = strip_tags($new_instance['timezone']);
		$instance['categories'] = $new_instance['categories'];
		$instance['auto_scroll'] = $new_instance['auto_scroll'];
		$instance['disable_url'] = $new_instance['disable_url'];
	...
	function form($instance)
	{
		...
		$display_settings = esc_attr($instance['display_settings']);
		$within_next = esc_attr($instance['within_next']);
		$time_format = esc_attr($instance['time_format']);
		$time_format_custom = esc_attr($instance['time_format_custom']);
		$time_mode = esc_attr($instance['time_mode']);
		$timezone = esc_attr($instance['timezone']);
		$categories = $instance['categories'];
		$auto_scroll = $instance['auto_scroll'];
		$disable_url = $instance['disable_url'];
		$custom_url = $instance['custom_url'];
		$background_color = esc_attr($instance['background_color']);
		$hover_background_color = esc_attr($instance['hover_background_color']);
		$text_color = esc_attr($instance['text_color']);
		$hover_text_color = esc_attr($instance['hover_text_color']);
		$item_border_color = esc_attr($instance['item_border_color']);
		$hover_item_border_color = esc_attr($instance['hover_item_border_color']);
		?>
		<p>
		...
		<p <?php echo ($display_settings=="today" || $display_settings=="" ? ' style="display: none;"' : ''); ?>>
